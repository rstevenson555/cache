 ...
 * @author i0360b6
 */
public class IdleExpiringMRUCacheTest {

    public IdleExpiringMRUCacheTest() {
    }
    ...
    public void testGetFactory() {
        ...
        MRUCache instance = new MRUCache<String,String>(new IdleExpiringFactory<String,String>(1000));
    ...
    public void testEntrySet() {
        ...
        instance.put("Key2","Value2");
        HashSet set = new HashSet();
        set.add(new IdleExpiringMapEntry("Key1","Value1",cf));
        set.add(new IdleExpiringMapEntry("Key2","Value2",cf));
        Set expResult = set;
   ...
   /* @Test
    ...
    public void testClone() {
        try {
            ...
            Logger.getLogger(IdleExpiringMRUCacheTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
