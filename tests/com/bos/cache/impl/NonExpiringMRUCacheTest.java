 ...
 * @author i0360b6
 */
public class NonExpiringMRUCacheTest {

    public NonExpiringMRUCacheTest() {
    }
    ...
    public void testGetFactory() {
        ...
        MRUCache instance = new MRUCache<String,String>(new NonExpiringFactory<String,String>());
    ...
    public void testGetEntry() {
        ...
        Object key = "Key";
        CacheDataFactory<String,String> cf = new NonExpiringFactory<String,String>();
    ...
    /**
     * Test of iterator method, of class MRUCache.
     */
    /*@Test
    ...
    public void testEntrySet() {
        ...
        set.add(new NonExpiringMapEntry("Key1","Value1",cf));
        set.add(new NonExpiringMapEntry("Key2","Value2",cf));
        Set expResult = set;
   ...
   /* @Test
    ...
    public void testClone() {
        try {
            ...
            Logger.getLogger(NonExpiringMRUCacheTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
